...
public class Chart_Kosong extends JComponent {

    public Chart_KosongRender getBlankPlotChatRender() {
        return blankPlotChatRender;
    }

    public void setBlankPlotChatRender(Chart_KosongRender blankPlotChatRender) {
    ...
    private Chart_Skala niceScale;
    private double maxValues;
    private double minValues;
    private int labelCount;
    private String valuesFormat = "#,##0.##";
    private Chart_KosongRender blankPlotChatRender;
    ...
    public void initValues(double minValues, double maxValues) {
        ...
        this.maxValues = maxValues;
        niceScale = new Chart_Skala(minValues, maxValues);
        repaint();
    }
    ...
    public Chart_Ukuran getRectangle(int index, double height, double space, double startX, double startY) {
        double x = startX + space * index;
        Chart_Ukuran size = new Chart_Ukuran(x, startY+1, space, height);
        return size;
    }
