...
public class Form_Dashboard extends javax.swing.JPanel {
    ...
    public Form_Dashboard() {
        initComponents();
        card1.setData(new Model_Card(new ImageIcon(getClass().getResource("/icon/stock.png")), "Total Penjualan", "Rp 1.714.286", "Mencapai 60%"));
        card2.setData(new Model_Card(new ImageIcon(getClass().getResource("/icon/profit.png")), "Total Pembelian", "Rp 714.286", "Mencapai 25%"));
        card3.setData(new Model_Card(new ImageIcon(getClass().getResource("/icon/flag.png")), "Total Keuntungan", "Rp 2.000.000", "Mencapai 70%"));
